...
amount.oninput = () => {
  // Faz com que o input só aceite caracteres númericos.
...
function expenseAdd(newExpense){
  try {
    ...
    // Adiciona nome e categoria na div das infromações da despesa.
    ...
    // Cria o botão de remover a despesa da lista.
...
// Atualiza os totais (despesas e valor).
function updateTotals(){
  try {
    ...
    // Percorre cad item (li) da lista (ul).
